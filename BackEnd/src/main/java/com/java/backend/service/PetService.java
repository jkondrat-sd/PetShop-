...
public class PetService {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public PetResponse updatePet(Long petId, PetRequest request, MultipartFile thumbnailFile, List<MultipartFile> imageFiles) {
        PetEntity pet = petRepository.findById(petId)
                .orElseThrow(() -> new AppException(ErrorCode.PET_NOT_FOUND));
        ...
        if (request.getUnitPrice() != null) pet.setUnitPrice(request.getUnitPrice());
